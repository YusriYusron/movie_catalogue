...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.yusriyusron.tvmovies.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.yusriyusron.tvmovies.EXTRA_ITEM";
